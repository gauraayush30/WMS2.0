...
export default function ViewProduct() {
  ...
  const detailCards = [
    ...
    {
      label: "Stock",
      value: product.stock_at_warehouse,
      icon: Warehouse,
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList>
          <TabsTrigger value="details">
            <Package size={14} className="mr-1.5" /> Details
          </TabsTrigger>
          <TabsTrigger value="analytics">
            <BarChart3 size={14} className="mr-1.5" /> Analytics
          </TabsTrigger>
          <TabsTrigger value="forecast">
            <Brain size={14} className="mr-1.5" /> Demand Forecast
          </TabsTrigger>
          <TabsTrigger value="history">
            <History size={14} className="mr-1.5" /> Edit History
          </TabsTrigger>
        </TabsList>
                  ...
                  <CardContent className="flex items-center gap-4 p-4">
                    ...
                    <div className="min-w-0">
                      ...
                      {c.badge ? (
                        <Badge
                          variant={
                            c.badge as "success" | "warning" | "destructive"
                          }
                        >
                          {String(c.value)}
                        </Badge>
        ...
        <TabsContent value="analytics">
          <motion.div
            ...
            className="mt-2"
          >
            <ProductAnalyticsTab productId={id!} product={product} />
          </motion.div>
        </TabsContent>
                  ...
                  <TableBody>
                    {auditLog.map((entry) => (
                      <TableRow key={entry.id}>
                        ...
                        <TableCell className="text-xs text-red-500 line-through">
                          {entry.old_value}
                        </TableCell>
